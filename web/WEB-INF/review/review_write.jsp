...
<div class="container-fluid bg-secondary mb-5">
    <div class="d-flex flex-column align-items-center justify-content-center" style="min-height: 300px">
        <h1 class="font-weight-semi-bold text-uppercase mb-3">리뷰 작성</h1>
        <div class="d-inline-flex">
            <p class="m-0"><a href="home.do">Home</a></p>
            <p class="m-0 px-2">-</p>
            <p class="m-0">Review Write</p>
        </div>
    </div>
</div>
<!-- Page Header End -->
...
<div class="container-fluid pt-5">
    ...
    <div class="px-xl-5">
        <div class="col-7 mb-5" style="margin: 0 auto;">
            <div class="contact-form">
                <div class="success"></div>
                <form novalidate="novalidate" action="reviewWrite.do" method="post" enctype="multipart/form-data">
                    <div class="control-group">
                        <input type="text" class="form-control" name="reviewTitle" placeholder="제목" required="required" data-validation-required-message="제목을 입력해주세요.">
                        <p class="help-block text-danger"></p>
                    </div>
                    <div class="control-group">
                        <input type="text" class="form-control" name="foodName" placeholder="음식 이름" required="required" data-validation-required-message="음식 이름을 입력해주세요.">
                        <p class="help-block text-danger"></p>
                    </div>
                    <div class="control-group">
